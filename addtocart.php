...
<body>
    ...
    <h4 class="mt-2 text-center">Your Added Product <b class="badge badge-primary">12</b>
    </h4>
    ...
    <div class="container ">
        ...
        <button type="button" class="btn btn-primary btn-lg btn-block mt-4 mb-5">Check out  <b class="badge badge-success">425</b></button>
    </div>
    <!-- js and jquery  -->
